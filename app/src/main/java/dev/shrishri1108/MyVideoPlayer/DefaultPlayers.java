package dev.shrishri1108.MyVideoPlayer;
...
import dev.shrishri1108.MyVideoPlayer.Client.RetrofitClient;
import dev.shrishri1108.MyVideoPlayer.Model.Video_listResponse.VideoListResponse;

import dev.shrishri1108.MyVideoPlayer.R;
import dev.shrishri1108.MyVideoPlayer.databinding.ActivityDefaultPlayersBinding;
        ...
        call.enqueue(new Callback<VideoListResponse>() {
            ...
            public void onResponse(Call<VideoListResponse> call, Response<VideoListResponse> response) {
                if(response.isSuccessful()) {
                    ...
                    for (dev.shrishri1108.MyVideoPlayer.Model.Video_listResponse.Result myVideo :videoListResponse.getResults()){
